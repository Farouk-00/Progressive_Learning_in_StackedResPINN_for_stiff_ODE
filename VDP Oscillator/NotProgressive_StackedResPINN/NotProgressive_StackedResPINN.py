...
class StackedResPINN:
    def __init__(self, model, optimizer_primal, optimizer_dual, lr_scheduler=None, patience=100, N_collocation=1000, N_resample=50, N_dual=10, gammas_init=[], parameters_init=3.0, logger=None, T_max=2.0):
        self.model = model
...
if __name__ == "__main__":
    ...
    pinn.train(t_collocation, n_stacked_mf_layers, epochs=50000, t_test=t_test, u_test=u_tests, u_0=u_0)
